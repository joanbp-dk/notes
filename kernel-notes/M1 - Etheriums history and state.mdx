# Kernel module 1 (Etherium’s History and State)

- **Meaning**
- **Value**
- **Playdough Protocols**
- **The Ideas behind Etherium**
- **Etherial Dreamers**
...
[Vitalik - Understanding the Etherium Protocol](https://youtu.be/gjwr-7PgpN8)

Calculator (Bitcoin) vs smartphone (Ethereum).

Features of Etherium:
...
Etherium’s state: Mapping of addresses > account objects.
...
Etherium Foundation values: **Kaizen** (continuous improvement) + Principle of Subtraction (growing small).  
...
Etherium founders: Motivated not by money but passion for the idea of a free, open and decentralized world.
